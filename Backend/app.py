#this prototype is based a youtube video 
#https://www.youtube.com/watch?v=DJnH0jR8y5Q min: 8:00
import subprocess
...
#set up of different database tables
